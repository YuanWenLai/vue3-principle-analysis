...
function trigger(target, key ,type) {
    console.log("🚀 ~ file: 5.7 代理数组.js:93 ~ trigger ~ key:", key)
    ...
    if(type === TrrigerType.ADD && Array.isArray(target)) {
        // 取出与length相关的副作用函数
        const lengthEffects = depsMap.get('length')
        console.log("🚀 ~ file: 5.7 代理数组.js:126 ~ trigger ~ lengthEffects:", lengthEffects)
...
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:422 ~ obj:", ...obj)

// test 3
// const arr = [1,2,3,4,5]
// const itr = arr[Symbol.iterator]()
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:432 ~ itr:", itr.next())
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:432 ~ itr:", itr.next())
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:432 ~ itr:", itr.next())
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:432 ~ itr:", itr.next())
// console.log("🚀 ~ file: 5.7.2 数组遍历.js:432 ~ itr:", itr.next())
